    ...
    methods: {
      ...
      submitBooking() {
        ...
        let contractData = {
          ...
          user: this.user,
          contractInfo: {
            title: this.currentProperty.contract.title,
            subtitle: this.currentProperty.contract.subtitle,
            copyright: this.currentProperty.contract.copyright,
            text: this.currentProperty.contract.text,
            fieldsArray: this.currentProperty.contract.fields,
            logo: this.currentProperty.contract.base64,
          },
          clientData: {
